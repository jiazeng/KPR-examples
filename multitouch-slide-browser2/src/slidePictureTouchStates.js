/* *     Copyright (C) 2010-2016 Marvell International Ltd. *     Copyright (C) 2002-2010 Kinoma, Inc. * *     Licensed under the Apache License, Version 2.0 (the "License"); *     you may not use this file except in compliance with the License. *     You may obtain a copy of the License at * *      http://www.apache.org/licenses/LICENSE-2.0 * *     Unless required by applicable law or agreed to in writing, software *     distributed under the License is distributed on an "AS IS" BASIS, *     WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied. *     See the License for the specific language governing permissions and *     limitations under the License. *//*** This is an updated JavaScript version of the the slidePictureTouchStates.xml module from the MultiTouchLib library* https://github.com/Kinoma/kinomajs/blob/master/kinoma/kpr/libraries/MultiTouchLib/src/slidePictureTouchStates.xml**/
...
var SnapbackYState = function(scroller) {
	TouchState.call(this, scroller);
	this.scroller = scroller
	this.id = "SnapbackY"
	this.duration = 1000
}
SnapbackYState.prototype = Object.create(TouchState.prototype, {
	onEnter: {
		value(fromState) {
...
SnapbackState.prototype = Object.create(TouchState.prototype, {
	onEnter: {
		value(fromState) {
			var picture = this.picture = this.scroller.behavior.getFocusedPicture()
...
SlideIdleState.prototype = Object.create(TouchState.prototype, {
	onEnter: {
		value(fromState) {
...
ZoomedDraggingState.prototype = Object.create(TouchState.prototype, {
	getPicture: {
		value() {
			return this.scroller.behavior.getFocusedPicture()
		}
...
VDraggingState.prototype = Object.create(TouchState.prototype, {
	onEnter: {
		value(fromState) {
			var picture = this.picture = this.scroller.behavior.getFocusedPicture()
			updateOriginAndTranslationForNewOrigin(picture,  { x : 0, y : 0 })
...
HScrollingState.prototype = Object.create(TouchState.prototype, {
	onEnter: {
		value(fromState) {
...
SnapbackScrollState.prototype = Object.create(TouchState.prototype, {
	onEnter: {
		value(fromState) {
...
QuickScrollState.prototype = Object.create(TouchState.prototype, {
	onEnter: {
		value(fromState) {
...
PanZoomState.prototype = Object.create(TouchState.prototype, {
	onEnter: {
		value(fromState) {
			this.needsSnapback = false
			var picture = this.picture = this.scroller.behavior.getFocusedPicture()
...
ZoomInAboutPointState.prototype = Object.create(TouchState.prototype, {
	onEnter: {
		value() {
			var picture = this.picture = this.scroller.behavior.getFocusedPicture()
...
ZoomHoldingAboutPointState.prototype = Object.create(TouchState.prototype, {
	onEnter: {
		value() {
			var picture = this.picture = this.scroller.behavior.getFocusedPicture()
			// translate by the correct amount to nullify the change of origin
...
AnimateZoomToFitState.prototype = Object.create(TouchState.prototype, {
	onEnter: {
		value(fromState) {
			var picture = this.scroller.behavior.getFocusedPicture()
			var rotation = 0
...
TossAndBouncebackState.prototype = Object.create(TouchState.prototype, {
	onEnter: {
		value(fromState) {
...
PinchPictureState.prototype = Object.create(TouchState.prototype, {
	onEnter: {
		value() {
			var picture = this.picture = this.scroller.behavior.getFocusedPicture()
			if (picture) {
...
AnimateRotationToNearestQuarterTurnState.prototype = Object.create(TouchState.prototype, {
	onEnter: {
		value() {
			var picture = this.picture = this.scroller.behavior.getFocusedPicture()
			if (picture) {
...
export var K3GuideSlideViewer =  Scroller.template($ => ({ 
	left: 0, right: 0, top: 0, bottom: 0, active: true, 
	Behavior: SlideScrollerBehavior,
	contents: [
		Line($, { 
			...
			contents: [
				Container($, { width: 320, height: 240, contents: [
					Container($, { width: 320, height: 240, anchor: 'FIRST_PICTURE_CONTAINER', behavior: new PageAdaptBehavior, contents: [
						Picture($, { left: 0, top: 0, active: true, behavior: new SlidePictureBehavior, }),
						Content($, { visible: false, skin: busySkin, anchor: 'FIRST_BUSY', Behavior: BusyBehavior, }),
					], }),
				], }),
				Container($, { width: 320, height: 240, contents: [
					Container($, { width: 320, height: 240, anchor: 'SECOND_PICTURE_CONTAINER', behavior: new PageAdaptBehavior, contents: [
						Picture($, { left: 0, top: 0, active: true, behavior: new SlidePictureBehavior, }),
						Content($, { visible: false, skin: busySkin, anchor: 'SECOND_BUSY', Behavior: BusyBehavior, }),
					], }),
				], }),
				Container($, { width: 320, height: 240, contents: [
					Container($, { width: 320, height: 240, anchor: 'THIRD_PICTURE_CONTAINER', behavior: new PageAdaptBehavior, contents: [
						Picture($, { left: 0, top: 0, active: true, behavior: new SlidePictureBehavior, }),
						Content($, { visible: false, skin: busySkin, anchor: 'THIRD_BUSY', Behavior: BusyBehavior, }),
					], }),
				], }),
