...
import {
	...
	Behavior: class extends TouchBehavior {
		buildTouchStateMachine(container) {			var allowRotation = true;															return buildPictureTouchStateMachine(container, container.picture, allowRotation);	// note we pass both the container and the picture to be manipulated here		}		onCreate(container, data) {	
